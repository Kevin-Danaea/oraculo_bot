...
class GridBotConfig(Base):
    ...
    SISTEMA DE 3 CONFIGURACIONES FIJAS: ETH, BTC, MATIC
    ...
    config_type = Column(String, nullable=False, index=True)  # 'ETH', 'BTC', 'MATIC'
    
    # CONFIGURACIÓN DE TRADING
    pair = Column(String, nullable=False)  # Ej: "ETH/USDT", "BTC/USDT", "MATIC/USDT"
    ...
    is_active = Column(Boolean, default=False)  # Solo una configuración activa por usuario
